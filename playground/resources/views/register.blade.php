    ...
    <body class="h-full">
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Register to your account
                </h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-400">
                    Already a member?
                    <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300">Log in</a>
                </p>
            </div>
        </div>
